...
class BestModel:
    ...
    def __call__(self, weighted_average, average, tag):
        ...
        if weighted_average < self.weighted_average:
            ...
            self.trainer.save_checkpoint(os.path.join(self.trainer.cfg.output_dir, 'best_models', f'{tag}_best_model_0.tar'))
        ...
        if average < self.average:
            ...
            self.trainer.save_checkpoint(os.path.join(self.trainer.cfg.output_dir, 'best_models', f'{tag}_best_model_1.tar'))
        ...
        if self.running_average < self.smoothed_average:
            ...
            self.trainer.save_checkpoint(os.path.join(self.trainer.cfg.output_dir, 'best_models', f'{tag}_best_model_3.tar'))
