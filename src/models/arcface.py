...
class Arcface(IResNet):
    def __init__(self, pretrained_path=None, freeze='l4', **kwargs):
        ...
        self.freeze = freeze
        if self.freeze == 'l2':
            self.freezer([self.layer1, self.conv1, self.bn1, self.prelu])
        elif self.freeze == 'l3':
            self.freezer([self.layer1, self.layer2, self.conv1, self.bn1, self.prelu])
        else:
